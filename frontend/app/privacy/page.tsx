...
export default function PrivacyPage() {
  return <main className="legal-page">
    ...
    <section>
      ...
      <p>Beanmemo is an early public preview. Avoid entering secrets or information unrelated to coffee. Features and the data model may change while testing continues.</p>
