    ...
    <div className="story-demo" aria-label="Example of how Beanmemo grows with each coffee">
      ...
      <div className="story-stage">
        ...
        <div className={`story-panel story-panel-${active}`} id={`story-panel-${active}`} role="tabpanel" aria-labelledby={`story-tab-${active}`}>
          {active === 0 && <div className="story-bean-card"><span>On your shelf · Example</span><div className="story-bag">FIVE<br />ELEPHANT<small>ETHIOPIA</small></div><div className="story-bean-copy"><b>Halo Beriti</b><p>Jasmine · Bergamot · Peach</p><small>Washed · Filter roast</small><dl className="story-bean-profile"><div><dt>Roast</dt><dd>Light</dd></div><div><dt>Acidity</dt><dd>4 / 5</dd></div><div><dt>Intensity</dt><dd>2 / 5</dd></div></dl></div></div>}
